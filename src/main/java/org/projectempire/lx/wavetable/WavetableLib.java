...
public class WavetableLib {
  ...
  static public Wavetable[] sharedWavetables = new Wavetable[11];
  ...
  static private void buildWavetables(int samples, int width, float pscale, boolean forward) {
    ...
    Wavetable triangleWavetable = wavetable;
    wavetable.generateWavetable(1f, 0f);
    ...
    wavetable = new BeveledUnityWavetable(samples);
    wavetable.generateWavetable(1f, 0f);
    ...
    wavetable = new PerlinWavetable(samples, 1, pscale);
    wavetable.generateWavetable(1f, 0f);
    wavetable.multiply(triangleWavetable);
    sharedWavetables[10] = wavetable;
